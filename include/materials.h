...
public:
    Button(std::pair<int, int> _x, std::pair<int, int> _y, bool* _pressed, std::string _text, std::string _disabledText = ""):hovering(false), x(_x), y(_y), pressed(_pressed), text(_text), disabledText(_disabledText){}
